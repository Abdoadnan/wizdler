...
public class SoapContext {
    ...
    private final ISoapMultiValuesProvider multiValuesProvider;
    ...
    public SoapContext(boolean exampleContent, boolean typeComments, boolean valueComments,
                       ...
                       Set<QName> excludedTypes, ISoapMultiValuesProvider multiValuesProvider) {
    ...
    public ISoapMultiValuesProvider getMultiValuesProvider() {
    ...
    public static class ContextBuilder {
        ...
        private ISoapMultiValuesProvider multiValuesProvider = null;
        ...
        public ContextBuilder multiValuesProvider(ISoapMultiValuesProvider multiValuesProvider) {
            this.multiValuesProvider = multiValuesProvider;
            return this;
        }
